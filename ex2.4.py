...
with open('Assignment-2/data.json', 'r') as inf:
    array = json.load(inf)
...
def func2(array, start, end):
    #By changing the pivot point to be the median of the array, 
    #the QuickSort algorithm will be more optimized for already sorted data.
    p = array[end//2]
    low = start + 1
    high = end
    while True:
